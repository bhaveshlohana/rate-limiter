...
import com.bhavesh.learn.rate_limiter.exception.InvalidConfigException;
import com.bhavesh.learn.rate_limiter.model.RateLimitConfig;
import com.bhavesh.learn.rate_limiter.util.RateLimiterUtils;
import com.bhavesh.learn.rate_limiter.validator.RateLimitConfigValidator;
...
import static com.bhavesh.learn.rate_limiter.constants.ApplicationConstants.DEFAULT;
import static com.bhavesh.learn.rate_limiter.constants.ApplicationConstants.RATELIMIT_CONFIG_PREFIX;
...
public class ClientConfigService {
    ...
    public Map<String, RateLimitConfig> getAllConfigs() {
        ...
        redisTemplate.keys(key).forEach(k -> {
            String clientType = k.replace(RATELIMIT_CONFIG_PREFIX, "");
            try {
